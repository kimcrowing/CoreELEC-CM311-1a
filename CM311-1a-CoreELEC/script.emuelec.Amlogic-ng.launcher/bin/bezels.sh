...
INIFILE="/storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/config/bezels/settings.ini"
DEFAULT_BEZEL="false"
...
BEZELMAP="/storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/config/bezels/arcademap.cfg"
