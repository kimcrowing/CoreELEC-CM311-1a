...
EE_LOG_DIR=/storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/logs
...
# pack logfiles
  mkdir -p /storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/logs
  zip -jq /storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/logs/log-$DATE.zip $BASEDIR/$LOGDIR/*
  cat $BASEDIR/$LOGDIR/* > /storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/logs/FULL_EMUELEC.LOG
  pastebinit /storage/.kodi/addons/script.emuelec.Amlogic-ng.launcher/logs/FULL_EMUELEC.LOG
